...
const Login = () => {
  ...
  const loginUser = async (e) => {
    ...
    try {
      const res = await fetch(`${(import.meta.env.VITE_API_URL || (window.location.hostname === "localhost" ? "http://localhost:5000" : "https://backend-mentor.onrender.com"))}/api/auth/login`, {
        method: "POST",
        headers: {
